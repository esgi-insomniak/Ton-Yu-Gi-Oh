...
export default (props: CardProps) => {
    ...
    return (
        <animated.div className={`card ${props.types.join(' ').toLocaleLowerCase()} / interactive ${interacting ? 'interacting' : ''} ${loading ? 'loading' : ''}`} data-number={props.number} data-set={props.set} data-subtypes={props.subtypes.join(' ').toLowerCase()} data-supertype={props.supertype.toLowerCase()} data-rarity={props.rarity.toLowerCase()} data-trainer-gallery={false} style={dynamicStyles} ref={thisCard}>
