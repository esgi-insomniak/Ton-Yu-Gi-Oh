...
import { IGroupedUserCardSet, IUserCardSet } from './user-card-set.interface';
...
export class GetGroupedUserCardSetsResponseDto {
  @ApiProperty({
    example: [
      {
        cardSetId: '0016b72a-1104-4cd3-a57a-efd51763cbb7',
        userCardSets: [
          {
            id: '03a54917-a491-462c-b1b0-0730ddbad892',
            userId: 'cfd4195c-362b-4b37-b25d-3a35ecb88368',
            cardSet: {
              ...
              card: {
                ...
                linkVal: null,
                imageUrl:
                  'https://images.ygoprodeck.com/images/cards/97077563.jpg',
                imageUrlSmall:
                  'https://images.ygoprodeck.com/images/cards_small/97077563.jpg',
              },
              set: {
