...
const GameCardInfos = (props: IGameCard) => {
  ...
  return (
    <div className='absolute top-1/2 inset-y-0 left-[125%] transform -translate-y-1/2 bg-[#2a303c] bg-opacity-90 h-fit lg:w-[500px] md:w-[350px] sm:w-[200px] p-3 space-y-2 text-white rounded-md text-xs border-2 pointer-events-auto' >
